  ...
  for color in '' '-Dark'; do
    for type in '' '-Nord' '-Dracula'; do
      ...
      if [[ "$type" != '' ]]; then
        ...
        if [[ "$color" == '' ]]; then
          sed -i "s/#009688/${theme_color}/g" "assets${theme}${color}${type}.svg"
          # sed -i "s/#FAFAFA/${background_color}/g" "assets-common${color}${type}.svg"
        else
          sed -i "s/#4DB6AC/${theme_color}/g" "assets${theme}${color}${type}.svg"
          # sed -i "s/#2C2C2C/${background_color}/g" "assets-common${color}${type}.svg"
        fi
      elif [[ "$theme" != '' ]]; then
        cp -r "assets${color}.svg" "assets${theme}${color}.svg"
        if [[ "$color" == '' ]]; then
          sed -i "s/#009688/${theme_color}/g" "assets${theme}${color}.svg"
        else
          sed -i "s/#4DB6AC/${theme_color}/g" "assets${theme}${color}.svg"
        fi
      fi
